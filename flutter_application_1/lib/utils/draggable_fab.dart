...
class DraggableFab extends StatefulWidget {
  ...
  const DraggableFab(
      {Key? key, required this.child, this.initPosition, this.securityBottom: 88})
      : super(key: key);
  ...
  void _calculatePosition(Offset targetOffset) {
    ...
    switch (_getAnchor(targetOffset)) {
      ...
      case Anchor.RIGHT_SECOND:
        this._left = _screenWidth - _widgetSize.width * 1.5;
        this._top = max(_widgetSize.height, targetOffset.dy);
        break;
      case Anchor.TOP_SECOND:
        this._left = min(_screenWidth - _widgetSize.width * 1.5, targetOffset.dx);
        this._top = _widgetSize.height / 2;
        break;
